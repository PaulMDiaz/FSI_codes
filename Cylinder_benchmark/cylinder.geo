...
Point(6) = {0.2,  0.2+radius, 0, cl2};
Point(7) = {0.2, 0.2-radius, 0, cl2};
Point(8) = {0.2,  0.2+outer, 0, cl2};
Point(9) = {0.2, 0.2-outer, 0, cl2};
Point(10) = {0.2+radius,  0.2, 0, cl2};
Point(11) = {0.2-radius, 0.2, 0, cl2};
Point(12) = {0.2+outer,  0.2, 0, cl2};
Point(13) = {0.2-outer, 0.2, 0, cl2};
