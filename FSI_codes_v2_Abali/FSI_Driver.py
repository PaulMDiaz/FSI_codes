...
#i_f_V_mid_l = np.where((dofs_f_V[:,1] >= ((DC.H-DC.h)/2+DC.h)-DC.H/DC.N/2) & (dofs_f_V[:,1] <= ((DC.H-DC.h)/2+DC.h)))[0]

#i_f_V_mid_u = np.where((dofs_f_V[:,1] >= ((DC.H-DC.h)/2+DC.h)) & (dofs_f_V[:,1] <= ((DC.H-DC.h)/2+DC.h+DC.H/DC.N/2)))[0]

#i_f_V_mid_ll = np.where((dofs_f_V[:,0] >= DC.W/2-DC.H/DC.N/2) & (dofs_f_V[:,0] <= DC.W/2)[0]

#i_f_V_mid_uu = np.where((dofs_f_V[:,1] >= ((DC.H-DC.h)/2+DC.h)) & (dofs_f_V[:,1] <= ((DC.H-DC.h)/2+DC.h+DC.H/DC.N/2)))[0]
