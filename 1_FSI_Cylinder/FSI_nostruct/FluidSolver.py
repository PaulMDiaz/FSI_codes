...
# interfaceFluidCoords2 = fluidSolver.interfaceFluidVectorSpace2.tabulate_dof_coordinates().reshape((fluidSolver.interfaceFluidVectorSpace2.dim(),-1))
		...
		# traction computation, needs vector space, test and trial functions. CG 1 or 2?
		self.tractionFluidVectorSpace = VectorFunctionSpace(meshSolver.mesh, "CG", 2)
	...
	def IPCS_Fluid_Solver(self, p_s, meshInterfaceVelocity, meshDisplacement, meshVelocity):
		print ""
		print ""
