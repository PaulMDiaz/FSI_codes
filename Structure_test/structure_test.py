...
class Structure_params:
    ...
    def Define_Boundary_Conditions(self, S):
        ...
        class Bottom(SubDomain):
            def inside(self, x, on_boundary):
                return near(x[1], 0.0)
        # These lines of code are an alternative way of handling the BCs, not sure if they are correct
        ...
        # Create Cell & Facet functions for Structure boundary and mark all 0
