...
Point(8) = {0.2,  0.2+radius, 0, cl2};
Point(9) = {0.2, 0.2-radius, 0, cl2};

Point(12) = {0.2+radius,  0.2, 0, cl2};
Point(13) = {0.2-radius, 0.2, 0, cl2};
...
Transfinite Line {7,8,15,16} = nc1;

// Structure
Point(24) = {0.2+radius, 0.2 - struct_h/2, 0, cl4};
Point(25) = {0.2+radius+struct_l, 0.2-  struct_h/2, 0, cl4};
Point(26) = {0.2+radius+struct_l, 0.2+struct_h/2, 0, cl4};
Point(27) = {0.2+radius, 0.2+struct_h/2, 0, cl4};
Line(24) = {24, 25};
Line(25) = {25, 26};
Line(26) = {26, 27};
Line(27) = {27, 24};
...
Line Loop(1) = {1, 2, 3, 4, 7, 16, 8, 15}; // Exterior
Line Loop(2) = {24, 25, 26, 27}; // Structure boundary
