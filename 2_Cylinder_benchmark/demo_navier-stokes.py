...
# Try a velocity with 0.5 maximum.

# Define inlet profile
U_mean = 0.2
v_in = ('0','1.5*U_mean*x[0]*(0.5-x[0])/pow(0.25, 2)')
...
#inflow  = DirichletBC(V, v_in, "x[1] > 1.0 - DOLFIN_EPS")
inflow = DirichletBC(V, Expression(v_in, U_mean = U_mean, degree=2), "x[1] > 1.0 - DOLFIN_EPS")
