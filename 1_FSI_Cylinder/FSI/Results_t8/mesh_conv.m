...
% % load and truncate
% load('cylinder_fsi_course_t2.mat')
% results_t2 = results(1:2000,:);
% load('cylinder_fsi_course_t2_2_5.mat')
% results_t2_2_5 = results(1:500,:);
% load('cylinder_fsi_course_t2_5.mat')
% load('cylinder_fsi_course.mat')
% results_t2_5 = results(1:end-1000, :);
% results = [results_t2; results_t2_2_5; results_t2_5]; 
% save('cylinder_fsi_med_t8.mat','results');

load('cylinder_fsi_med_t8.mat');
...
ylabel('$u_x$ [m]', 'interpreter', 'latex', 'fontsize', 20);
ylim([1.4e-5, 2.4e-5])
% % ylim([0, 0.1])
% 
...
%         'latex', 'fontsize', 16);
xlabel('time [s]', 'interpreter', 'latex', 'fontsize', 20);
ylabel('$u_y$ [m]', 'interpreter', 'latex', 'fontsize', 20);
ylim([-3e-4, 10e-4])
...
%         'latex', 'fontsize', 16);
xlabel('time [s]', 'interpreter', 'latex', 'fontsize', 20);
ylabel('drag [N]', 'interpreter', 'latex', 'fontsize', 20);
ylim([12, 16])
...
%         'latex', 'fontsize', 16);
xlabel('time [s]', 'interpreter', 'latex', 'fontsize', 20);
ylabel('lift [N]', 'interpreter', 'latex', 'fontsize', 20);
ylim([-01, 1.4])
