...
dofs_s_V2 = S.mixed_space.tabulate_dof_coordinates().reshape((S.mixed_space.dim(),-1))
...
while p_s.t <= p_s.T: # + DOLFIN_EPS:
	...
	for ii in range(3):
		...
		u11, v11 = S.U.split(deepcopy = True)
		u_s_FSI = u11.vector()[i_s_V_fsi]
		v_s_FSI = v11.vector()[i_s_V_fsi]
